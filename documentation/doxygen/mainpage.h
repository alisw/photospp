/** 
 ...
 - <a href="resources/PHOTOS.3.64/Photos_interface_design.3.64.pdf">Photos_interface_design.pdf</a> full software documentation.
 - <a href="resources/PHOTOS.3.64/PHOTOS.3.64.tar.gz">PHOTOS 3.64 source code </a> tarball
   ( <a href="resources/PHOTOS.3.64/PHOTOS.3.64-LHC.tar.gz"> version for LHC/LCG</a>  installation)
   and its <a href="resources/PHOTOS.3.64/svn_info_photos.3.64.txt">revision info</a> SVN tag, tarball creation date/time, etc.
   For updates with respect to release 3.0 see <a href="resources/PHOTOS.3.64/changelog.3.64.txt">changelog.txt</a>

 <b>IMPORTANT NOTE:</b> Since release 3.64 we have added HepMC3 support (HepMC3 is avialble on the official <a href="https://hepmc.web.cern.ch/hepmc/">HepMC website</a>).
 We have also adapted examples to Tauola v1.1.8 which means <b>Tauola examples and tests will not compile with Tauola v1.1.6 or older</b>.
