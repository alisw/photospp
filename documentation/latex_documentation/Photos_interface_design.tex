...
\begin{itemize}
  ...
  \item {\tt Photos::forceMass(int pdgid, double mass)} {\it  installed in {\tt PHOTOS 3.4}} \\
        ...
        from 4-vector.
        Option active if {\tt forceMassFrom4Vector = true} (default).
  \item {\tt Photos::forceMassFromEventRecord(int pdgid)} {\it  installed in {\tt PHOTOS 3.4} \\
        ...
        Option active if {\tt forceMassFrom4Vector = true} (default).
  \item {\tt Photos::createHistoryEntries(bool flag %int Status
         )} {\it  installed in {\tt PHOTOS 3.4}} \\
  ...
  \item {\tt Photos::IgnoreParticlesOfStatus(int Status)} {\bf To be prepared soon} decay products of {\tt Status} will be ignored
        in check of momentum conservation and will not be passed to algorithm generating bremsstrahlung.\\
