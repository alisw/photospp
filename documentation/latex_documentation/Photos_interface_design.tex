...
{\tt Photos::suppressBremForDecay(4, 15, 16, -211, -211, 211); } \\
...
\emph{If the decays $\tau^- \rightarrow \nu_\tau \pi^- \pi^- \pi^+$ or
	  ...
	  In addition, all decays of particle $\pi^+$ will also be skipped. Note, that the minimum
...
\emph{When a decay $\tau^- \rightarrow \nu_\tau \pi^-$ is found, it will be skipped by
      {\tt PHOTOS} along with the decays of particles $\nu_\tau$ and $\pi^-$ and all
	  their daughters. In the end, the whole decay tree starting with
	  $\tau^- \rightarrow \nu_\tau \pi^-$ will be skipped.}
\end{itemize}
...
\emph{Since suppression of all processess is used, only the listed decays will be processed,
      ...
      and all instances of the decay of $\pi^+$ and its descendants.}
\end{itemize}
