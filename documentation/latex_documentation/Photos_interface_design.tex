...
\hline 
\hline 
 {$Z^{0} \rightarrow \mu^{+} \mu^{-} $} & {83.9591 $\pm$  0.0916\%} &{  83.7983 $\pm$  0.0463\%} & 83.8547 $\pm$ 0.0290 \%\\ 
\hline 
\hline 
 {$Z^{0} \rightarrow \gamma \mu^{+} \mu^{-} $} & {14.7665 $\pm$  0.0384\%} &{  14.8728 $\pm$  0.0195\%} & 14.8557$\pm$ 0.0122\% \\ 
\hline 
\hline 
{$Z^{0} \rightarrow \gamma \gamma \mu^{+} \mu^{-} $} & { 1.2744 $\pm$  0.0113\%} &{   1.3289 $\pm$  0.0058\%} & 1.2902 $\pm$ 0.0036\%\\ 
\hline 
\end{tabular}\par} 
...
\begin{figure}[h!]
\centering
\subfigure[CEEX2: red; CEEX1: green; ratio  CEEX2/CEEX1 black]{
\includegraphics[scale=0.35]{{M1@0001.eps}}
}
\subfigure[CEEX2: red; PHOTOS: green; ratio  CEEX2/PHOTOS black]{
