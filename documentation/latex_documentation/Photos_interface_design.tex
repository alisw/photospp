...
\subsection{Units and lepton pair emission \footnote{Added  Jan 23 2015, extended Feb 3 2015}}
\label{sec:units}

For the purpose of pair emission, introduced with {\tt Photos} version 3.57, the information about momentum unit
...
interface by calling {\tt Photos::setMomentumUnit(MomentumUnits unit); }. See
...
level of the pair effect (which itself is at the 0.1 \% level). 
