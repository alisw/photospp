...
On {\tt CERN} platforms, ready to use software is located in {\tt /afs/cern.ch/sw/lcg/}
directory. To set the appropriate paths, the scripts 
{\tt platform/afs.paths.sh} and {\tt platform/afs.paths.csh}, to be executed before
{\tt ./configure}, are prepared. For details see {\tt README} in {\tt PHOTOS} main directory.
...
\begin{itemize}
  ...
  \item {\tt Photos::forceMassFrom4Vector(bool flag)} \\
        ...
        If {\tt flag=false}, the particle mass from event record processed by 
        {\tt PHOTOS} is taking precedence. The choice may be important for control 
