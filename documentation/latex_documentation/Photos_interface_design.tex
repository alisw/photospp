...
This can be done if together with the PHOTOS Interface
these genuine weak corrections are provided with TAUOLA Interface.
...
When an elementary decay is to be modified by PHOTOS, it is first tranformed to the rest frame of the
...
{\tt Photos::suppressBremForDecay(4, tau, nutau, pi-, pi-, pi+); } \\
{\tt Photos::suppressBremForDecay(2, -15, BAR nutau, 211); } \\
{\tt Photos::suppressBremForDecay(0, 211); } \\
\emph{If the decays {\tt 15 => 16, -211, -211, 211} or {\tt -15 => -16, 211} are found, they will be skipped by {\tt PHOTOS}. In addition, all decays of particle {\tt 211} will also be skipped. Note, that the minimum number of parameters that must be provided is two - the number of daughters (which can be zero) and the mother PDGID.} \\ \\
...
%add: phlupa
Old {\tt FORTRAN} debugging routine {\tt PHLUPA} can be activated with the help of ... 
