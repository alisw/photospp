...
\begin{itemize}
  ...
  \item {\tt Photos::setMeCorrectionWtForW(bool corr)} \\
        ...
        Because of lack of reinitialization of matrix element for  a particular decay channel this option can be used for the fixed 
        decay channel, either for  $W^+$ or for $W^-$. Also it is requested that virtuality of the boson is fixed (not strongly 
        with respect to $W$ mass). 
        This option will be elaborated further. {\bf ZbW: I do not understand restriction. TP: I don't remember it as well. I only recall we had some problems with W. Needs to be investiagted. Most probably it is the question of initialization for the series. This warning may be leftover   from some remote version of the code.}
