...
on the units used by {\tt HepMC}). If larger energy-momentum non-conservation
        ...
        is used. That effectively means that {\it only} momentum, but not energy is checked. This turns out to be insufficient in some rare cases. 
We expect {\tt HepMC}
to be appropriately extended in its future releases. Alternatively, easy to install
patch may be introduced into our method. 
