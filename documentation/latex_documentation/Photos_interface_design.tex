...
It s valid up to version 3.53. The following common blocks are directly replaced
by the struct objects of C starting from version 3.54 of the code:
{\tt PHOCOP, PHOKEY, PHOSTA, PHLUPY}.

Names of variables and structs are not modified but adapted to C++ definition style.
Common {\tt HEPEVT} evolved into larger data structure and its interface is available
through the use of classes {\tt PhotosHEPEVTEvent.h} and {\tt PhotosHEPEVTParticle.h}.
