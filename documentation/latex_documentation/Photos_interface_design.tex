...
{\bf OUTDATED SENTENCE? (See last paragraph of sect 4.2.
Z.W. Section 4.2 describes future option of emission in vertex like
q bar q to l+ l- gluon. At the same time it is stated in 4.2 that  for
 q bar q to  l+ l-. So we have point to clarify...
TP: this is a description of possible future option. It is valid. This option is not present.
Sect 4.2 describes potential extensions. This paragraph could be moved there.)}
