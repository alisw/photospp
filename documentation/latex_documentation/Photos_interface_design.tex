...
We were trying to be as adaptive as possible by providing user with options to
adapt event record so it can be used with {\tt Photos} (see Appendix \ref{subsection:other_methods}).
However, we have not blocked user froam using {\tt Photos} on events where Photos
may be able to act correctly (such as cases described in this section)
because user may willingly try to apply {\tt Photos} to such use cases
...
Event Records and Event Record standards. We have provided the interface to the
