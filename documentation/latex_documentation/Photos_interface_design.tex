...
\begin{itemize}
  ...
  \item {\tt Photos::maxWtInterference(double interference)} \\
        ...
        the decays like $J/\psi \to 5\pi^+ 5\pi^-$ higher value, at least number of charged decay 
        products should be set. The algorithm performance will slow linearly with the maximum interference weight but   all 
