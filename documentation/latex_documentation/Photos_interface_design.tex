...
\hline 
\hline 
{$ \widetilde{t} t \; \;\; \;$}  &  {98.9961 $\pm$ 0.0315\%}  \\ 
\hline 
%\hline 
 {$  \widetilde{t} t \gamma \;\;$} &   { 0.9972 $\pm$  0.0032\%}   \\ 
\hline 
%\hline 
{$  \widetilde{t} t \gamma \gamma$}  &  { 0.0068 $\pm$  0.0003 \%}  \\ 
\hline 
\end{tabular} 
}  
\end{center} 
...
examples may show differences higher than statistical error due to photon symmetrization
used in benchmark files generated with {\tt KKMC}.
