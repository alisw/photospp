...
\footnote{Note that relevant parameters listed here can be set through
the appropriate accessors (see Appendix \ref{subsection:other_methods}).}.
...
{\tt ./configure}. For details see {\tt README} in the {\tt PHOTOS} main directory\footnote { It is prepared for {\tt  Pythia} 8.2. For later  versions
