...
They can be recreated by performing the test located in {\tt examples/testing/Ztautau} directory.
\label{fig:KKMC}
}
\end{figure}
\begin{figure}[h!]
...
These plots has been created using custom {\tt UserTreeAnalysis} of {\tt MC-TESTER}.
They can be recreated by performing the test located in {\tt examples/testing/Htautau} directory.
...
These plots has been created using custom {\tt UserTreeAnalysis} of {\tt MC-TESTER}.
They can be recreated by performing the test located in {\tt examples/testing/Zee} directory.
\label{fig:lineshape}
}
\end{figure}
