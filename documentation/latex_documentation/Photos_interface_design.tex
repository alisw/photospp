...
\begin{itemize}
  ...
  \item {\tt Photos::setMeCorrectionWtForS(bool corr)} \\
         A switch for complete effects of the matrix element (in scalar to 2 scalar decays) {\it  to be installed in {\tt PHOTOS 3.3}. At present tests are missing. }
